...
# GC tuning
# Use G1GC for default, for sensitive low latency consider to use zgc
# https://www.oracle.com/technical-resources/articles/java/g1gc.html
# set MaxGCPauseMillis higher to increase throughput (decrease latency)
...
JVM_ARGS="$JVM_EA \
	...
	-Dspring.profiles.active=$APP_PROF"
